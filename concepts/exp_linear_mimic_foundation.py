...
DATASET_CONFIGS = {
    ...
    'mimic_no_expand': {
        'default_labels': os.path.join(_DATA_ROOT, 'mimic_phewas_no_expand_labels.parquet'),
        'meta_columns': {'dicom_id', 'subject_id', 'study_id', 'split',
                         'ViewPosition', 'icd_source'},
        'image_id_col': 'dicom_id',
        'patient_id_col': 'subject_id',
    ...
    'mimic63_no_expand': {
        'default_labels': os.path.join(_DATA_ROOT, 'mimic_63label_no_expand_labels.parquet'),
        'meta_columns': {'dicom_id', 'subject_id', 'study_id', 'split',
                         'ViewPosition', 'icd_source'},
        'image_id_col': 'dicom_id',
        'patient_id_col': 'subject_id',
