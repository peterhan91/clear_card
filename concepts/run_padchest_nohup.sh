#!/bin/bash
# ============================================================
# Run CLEAR + 4 FM linear probing on PadChest
# 193 classification labels, 87K/10K/39K splits, H5 at 1024x1024
#
# Usage:
#   nohup bash concepts/run_padchest_nohup.sh > concepts/results/padchest_run.log 2>&1 &
# ============================================================
set -e
...
echo "=========================================="
echo "Start: $(date)"
echo "Dataset: $DATASET (193 classification labels)"
echo "=========================================="
...
for dir in linear_padchest_kalm_gemma3_12b \
    linear_padchest_foundation_rad_dino \
    linear_padchest_foundation_biomedclip \
    linear_padchest_foundation_chexzero \
    linear_padchest_foundation_ark_plus; do
